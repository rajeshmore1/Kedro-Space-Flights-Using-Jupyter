...
# jupyterspaceflight documentation build
...
from jupyterspaceflight import __version__ as release

# -- Project information -----------------------------------------------------

project = "jupyterspaceflight"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "jupyterspaceflightdoc"
...
latex_documents = [
    (
        master_doc,
        "jupyterspaceflight.tex",
        "jupyterspaceflight Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "jupyterspaceflight",
        "Project jupyterspaceflight codebase.",
        "Data-Science",
    )
]
